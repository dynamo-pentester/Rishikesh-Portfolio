...
const certificates = [
  ...
  },
  {
    ...
    date: '2024',
    credential: 'SBT-NA',
    description: 'Packet analysis, protocol dissection, and network forensics using Wireshark.',
    link: '#',
  },
  {
    id: 4,
    title: 'Cisco Networking & Python',
    issuer: 'Cisco',
    date: '2023',
    credential: 'CISCO-NP',
    description: 'Network fundamentals, routing/switching, and Python for network automation.',
    link: '#',
  },
  {
    id: 5,
    ...
    date: '2023',
    credential: 'EH-INT',
    description: 'Penetration testing methodologies, vulnerability scanning, and exploit techniques.',
    link: '#',
  },
  {
    id: 6,
